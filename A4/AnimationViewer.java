...
class AnimationViewer extends JComponent implements Runnable {
	...
	class ShapeModelAdapter extends AbstractTableModel implements TreeModel {
	    ...
	    public void insertNodeInto(Shape newChild, NestedShape parent) {
	        ...
	        fireTreeNodesInserted(parent, new Object[] {
	            parent.getPath()
	        }, new int[] {
	            parent.indexOf(newChild)
	        }, new Object[] {
	            ((Object) newChild)
	        });
	        fireTableRowsInserted(parent.getSize(), parent.getSize());
					fireTreeStructureChanged(parent, new Object[] {parent.getPath()}, new int[] { parent.indexOf(newChild)}, new Object[] {((Object) newChild)});
	    }
	    ...
	    public void removeNodeFromParent(Shape selectedNode) {
	        ...
	        fireTreeNodesRemoved(parent, new Object[] {
	            parent.getPath()
	        }, new int[] {
	            index
	        }, new Object[] {
	            ((Object) selectedNode)
					 ...
					 fireTreeStructureChanged(parent, new Object[] {parent.getPath()}, new int[] { parent.indexOf(selectedNode)}, new Object[] {((Object) selectedNode)});
