 ...
 *  YOUR UPI: CCOR065 - Edited createNewShape method.
 *  =========================================================================================
 */
...
class AnimationViewer extends JComponent implements Runnable {
    ...
    private static int DELAY = 60;         // the current animation speed
    ...
    protected void createNewShape(int x, int y) {
		switch (currentShapeType) {
			case RECTANGLE:
            RectangleShape r = new RectangleShape(x,y,currentWidth,currentHeight,marginWidth, marginHeight,currentColor, currentPathType);
            shapes.add(r);
	        break;
        case OVAL:
            OvalShape ov = new OvalShape(x,y,currentWidth,currentHeight,marginWidth, marginHeight,currentColor, currentPathType);
            shapes.add(ov);
            break;
        case TRIANGLE:
            TriangleShape t = new TriangleShape(x,y,currentWidth,currentHeight,marginWidth, marginHeight,currentColor, currentPathType);
            shapes.add(t);
            break;
